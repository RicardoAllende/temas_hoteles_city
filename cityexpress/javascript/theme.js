...
$(function(){
    ...
    $val = $("#id_s_theme_cityexpress_popularCourse_type").val();
    if ($val == 1) {
    ...
    $("#id_s_theme_cityexpress_popularCourse_type").on('change', function() {
    ...
    var toggelSection = ['#theme_cityexpress_general', '#theme_cityexpress_slideshow', '#theme_cityexpress_marketingspot', '#theme_cityexpress_footer'];
    $.each(toggelSection, function(key, value) {
        ...
        h3.each( function(key) {
            ...
            var toggleHead = '<div class="cityexpress-toggle-head" id="' + childid + '">';
    ...
    $(".cityexpress-toggle-head").click(function(){
        $this = $(this);
    ...
    function toggleicon2(parentid) {
        ...
        parent.find('.cityexpress-toggle-head').each(function() {
            $this = $(this);
