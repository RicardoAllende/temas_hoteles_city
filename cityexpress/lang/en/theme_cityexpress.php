...
/**
 * Strings for component 'theme_cityexpress', language 'en'
 *
...
$string['copyrightdesc'] = 'Enter the copyright information as plain text or lang:language_key for multi-lingual support (Ex <b>lang:information</b>). <br/>You can find the default language keys here : /theme/cityexpress/lang[FOLDER].';
...
$string['cityexpress_settings'] = "cityexpress THEME SETTINGS";
$string['featuredcoursesheading'] = 'Featured Courses';
$string['footerblock'] = 'Footer Block';
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php';
...
$string['pluginname'] = 'City Express';
...
<br/>You can find the theme language keys here : /theme/cityexpress/lang/en/theme_cityexpress.php';
...
$string['slidedesctext'] = 'Enter the description for your slide as plain text or lang:language_key for multi-lingual support.<br>
 You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php';
...
$string['tmonialtext_default'] = 'We are building this curriculum with cityexpress because we believe it reflects what developers everywhere should know.';
...
$string['slideurl1textdesc'] = 'Use this option to set the text for first button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php';
$string['slideurl2text'] = 'Button 2 Text';
$string['slideurl2textdesc'] = 'Use this option to set the text for second button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php';
$string['mspottitledesc'] = 'Enter the block title as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php. <br/>You can find the default language keys here : /theme/cityexpress/lang[FOLDER].';
$string['mspotdescdesc'] = 'Enter the description as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php.';
$string['link'] = 'Link';
$string['text'] = 'Text';
$string['button'] = 'Button';
$string['target'] = 'Target';
$string['mspot2urldesc'] = 'Use this option to set the link for button.';
$string['mspot2urltxtdesc'] = 'Use this option to set the text for button. If you do not want to have button set this option to blank. Enter the button text as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress/lang/en/theme_cityexpress.php';
...
$string["cityexpress_type"] = "cityexpress theme custom style";
...
$string["logintheme"] = "cityexpress theme style";
$string['style'] = "Style";
