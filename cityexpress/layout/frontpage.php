...
$html = theme_cityexpress_get_html_for_settings($OUTPUT, $PAGE);
if (right_to_left()) {
...
<div class="page slide" >
    ...
    <link rel="stylesheet" href="<?php echo theme_cityexpress_theme_url(); ?>/style/slick.css" />
    <script type="text/javascript" src="<?php echo theme_cityexpress_theme_url();?>/javascript/slick.js"></script>
    <!--About Us-->
    ...
    // $PAGE->requires->js('/theme/cityexpress/javascript/slick.js');

    $status = theme_cityexpress_get_setting('marketingSpot1_status');
    if ($status == "1") {
        echo theme_cityexpress_marketingspot1();
    }
    ?>
    <!--E.O.About Us-->
    <!-- Marketing Spot 1 -->
    <?php
    $ms1status = theme_cityexpress_get_setting('marketingSpot1_status');
    if ($ms1status == 1) {
    ?>
        <div class="frontpage-siteinfo hidden">
            <div class="siteinfo-bgoverlay">
                <div class="container">
                <?php
                $msp1title = theme_cityexpress_get_setting('mspot1title', 'format_text');
                $msp1title = theme_cityexpress_lang($msp1title);
                $msp1desc = theme_cityexpress_get_setting('mspot1desc', 'format_text');
                $msp1desc = theme_cityexpress_lang($msp1desc);
    ...
    <div id="page" class="cityexpress-frontpage" style="">
...
require(['jquery'], function($) {
    ...
    $(".cityexpress-frontpage").find('br').hide();
    $(".cityexpress-frontpage").find('span.skip-block-to').each(function() {
        data = $(this).html();
        if(data.length == "") {
            $(this).hide();
        }
...
<?php
if ( $type = theme_cityexpress_combolist_type() == true) {
