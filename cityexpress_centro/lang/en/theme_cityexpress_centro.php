...
/**
 * Strings for component 'theme_cityexpress_centro', language 'en'
 *
...
$string['copyrightdesc'] = 'Enter the copyright information as plain text or lang:language_key for multi-lingual support (Ex <b>lang:information</b>). <br/>You can find the default language keys here : /theme/cityexpress_centro/lang[FOLDER].';
...
$string['cityexpress_centro_settings'] = "cityexpress_centro THEME SETTINGS";
$string['featuredcoursesheading'] = 'Featured Courses';
$string['footerblock'] = 'Footer Block';
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
...
$string['pluginname'] = 'City Express Centro';
...
<br/>You can find the theme language keys here : /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
...
$string['slidedesctext'] = 'Enter the description for your slide as plain text or lang:language_key for multi-lingual support.<br>
 You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
...
$string['tmonialtext_default'] = 'We are building this curriculum with cityexpress_centro because we believe it reflects what developers everywhere should know.';
...
$string['slideurl1textdesc'] = 'Use this option to set the text for first button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
$string['slideurl2text'] = 'Button 2 Text';
$string['slideurl2textdesc'] = 'Use this option to set the text for second button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
$string['mspottitledesc'] = 'Enter the block title as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php. <br/>You can find the default language keys here : /theme/cityexpress_centro/lang[FOLDER].';
$string['mspotdescdesc'] = 'Enter the description as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php.';
$string['link'] = 'Link';
$string['text'] = 'Text';
$string['button'] = 'Button';
$string['target'] = 'Target';
$string['mspot2urldesc'] = 'Use this option to set the link for button.';
$string['mspot2urltxtdesc'] = 'Use this option to set the text for button. If you do not want to have button set this option to blank. Enter the button text as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress_centro/lang/en/theme_cityexpress_centro.php';
...
$string["cityexpress_centro_type"] = "cityexpress_centro theme custom style";
...
$string["logintheme"] = "cityexpress_centro theme style";
$string['style'] = "Style";
