...
$(function(){
    ...
    $val = $("#id_s_theme_cityexpress_junior_popularCourse_type").val();
    if ($val == 1) {
    ...
    $("#id_s_theme_cityexpress_junior_popularCourse_type").on('change', function() {
    ...
    var toggelSection = ['#theme_cityexpress_junior_general', '#theme_cityexpress_junior_slideshow', '#theme_cityexpress_junior_marketingspot', '#theme_cityexpress_junior_footer'];
    $.each(toggelSection, function(key, value) {
        ...
        h3.each( function(key) {
            ...
            var toggleHead = '<div class="cityexpress_junior-toggle-head" id="' + childid + '">';
    ...
    $(".cityexpress_junior-toggle-head").click(function(){
        $this = $(this);
    ...
    function toggleicon2(parentid) {
        ...
        parent.find('.cityexpress_junior-toggle-head').each(function() {
            $this = $(this);
