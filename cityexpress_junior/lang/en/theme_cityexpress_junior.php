...
/**
 * Strings for component 'theme_cityexpress_junior', language 'en'
 *
...
$string['copyrightdesc'] = 'Enter the copyright information as plain text or lang:language_key for multi-lingual support (Ex <b>lang:information</b>). <br/>You can find the default language keys here : /theme/cityexpress_junior/lang[FOLDER].';
...
$string['cityexpress_junior_settings'] = "cityexpress_junior THEME SETTINGS";
$string['featuredcoursesheading'] = 'Featured Courses';
$string['footerblock'] = 'Footer Block';
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
...
$string['pluginname'] = 'City Express Junior';
...
<br/>You can find the theme language keys here : /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
...
$string['slidedesctext'] = 'Enter the description for your slide as plain text or lang:language_key for multi-lingual support.<br>
 You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
...
$string['tmonialtext_default'] = 'We are building this curriculum with cityexpress_junior because we believe it reflects what developers everywhere should know.';
...
$string['slideurl1textdesc'] = 'Use this option to set the text for first button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
$string['slideurl2text'] = 'Button 2 Text';
$string['slideurl2textdesc'] = 'Use this option to set the text for second button of the slide. If you do not want to have button on your slide set this option to blank.<br> Enter the button text as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
$string['mspottitledesc'] = 'Enter the block title as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php. <br/>You can find the default language keys here : /theme/cityexpress_junior/lang[FOLDER].';
$string['mspotdescdesc'] = 'Enter the description as plain text or lang:language_key for multi-lingual support.<br> You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php.';
$string['link'] = 'Link';
$string['text'] = 'Text';
$string['button'] = 'Button';
$string['target'] = 'Target';
$string['mspot2urldesc'] = 'Use this option to set the link for button.';
$string['mspot2urltxtdesc'] = 'Use this option to set the text for button. If you do not want to have button set this option to blank. Enter the button text as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/cityexpress_junior/lang/en/theme_cityexpress_junior.php';
...
$string["cityexpress_junior_type"] = "cityexpress_junior theme custom style";
...
$string["logintheme"] = "cityexpress_junior theme style";
$string['style'] = "Style";
