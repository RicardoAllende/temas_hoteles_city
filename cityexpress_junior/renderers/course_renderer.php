...
/**
 * Theme cityexpress_junior course renderer class inherit from core course renderer class.
 * @copyright  2015 onwards LMSACE Dev Team (http://www.lmsace.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_cityexpress_junior_core_course_renderer extends core_course_renderer {
    ...
    //         $content .= $this->cityexpress_junior_coursecat_category($chelper, core_course_category::get($key), 1);
    //     }
    ...
    public function top_course_menu() {
        ...
        '.get_string('viewall', 'theme_cityexpress_junior').'</a></li></ul>';
    ...
    //         $output .= html_writer::tag('h2', get_string('search_courses', 'theme_cityexpress_junior'));
    //     }
    ...
    //             'size' => $inputsize,
    //             'name' => 'search',
    //             'placeholder' => get_string('typesearch', 'theme_cityexpress_junior'),
    //             'value' => s($value)));
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        // $course_percentage = theme_cityexpress_junior_get_user_progress($course);
...
// print enrolmenticons
        ...
        $completion_information = theme_cityexpress_junior_completion_get_activities_in_course($course->id);
...
} // Here the theme_cityexpress_junior_course renderer fucntion closed.
