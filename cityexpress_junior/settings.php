...
if ($ADMIN->fulltree) {
    ...
    $temp = new admin_settingpage('theme_cityexpress_junior_faqs_tab', 'Preguntas frecuentes');

    // Course menu.
    $name = 'theme_cityexpress_junior/show_faqs';
    ...
    // Slide Link text.
    $name = 'theme_cityexpress_junior/faqs_link';
