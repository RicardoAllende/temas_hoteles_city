...
function footer_template() {
    ...
    $fb2title = theme_cityexpress_plus_get_setting('footerbtitle2', 'format_html');
    $fb2title = theme_cityexpress_plus_lang($fb2title);
    $fb3title = theme_cityexpress_plus_get_setting('footerbtitle3', 'format_html');
    $fb3title = theme_cityexpress_plus_lang($fb3title);
    $fb4title = theme_cityexpress_plus_get_setting('footerbtitle4', 'format_html');
