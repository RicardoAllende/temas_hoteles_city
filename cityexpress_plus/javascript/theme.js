...
$(function(){
    ...
    $val = $("#id_s_theme_cityexpress_plus_popularCourse_type").val();
    if ($val == 1) {
    ...
    $("#id_s_theme_cityexpress_plus_popularCourse_type").on('change', function() {
    ...
    var toggelSection = ['#theme_cityexpress_plus_general', '#theme_cityexpress_plus_slideshow', '#theme_cityexpress_plus_marketingspot', '#theme_cityexpress_plus_footer'];
    $.each(toggelSection, function(key, value) {
        ...
        h3.each( function(key) {
            ...
            var toggleHead = '<div class="cityexpress_plus-toggle-head" id="' + childid + '">';
    ...
    $(".cityexpress_plus-toggle-head").click(function(){
        $this = $(this);
    ...
    function toggleicon2(parentid) {
        ...
        parent.find('.cityexpress_plus-toggle-head').each(function() {
            $this = $(this);
