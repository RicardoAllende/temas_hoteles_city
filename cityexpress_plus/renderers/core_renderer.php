 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_cityexpress_plus_core_renderer extends theme_boost\output\core_renderer {
    ...
    protected function custom_menu_render(custom_menu $menu) {
        ...
        $cmenushow = theme_cityexpress_plus_get_setting('cmenushow');
        ...
        foreach ($menu->get_children() as $key => $item) {
            ...
            $skey = $key + 1;
            $coursemenu = $this->cityexpress_plus_course_menu_position($skey, $count);
     ...
     * @return type|null
     */
    public function cityexpress_plus_course_menu_position($skey, $count) {
        global $PAGE, $CFG;
        $status = "";
        $cmenuposition = $PAGE->theme->settings->cmenuPosition;
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        $maincontent = $this->render_from_template('theme_cityexpress_plus/login_form', $context);
        return  $maincontent;
    }
