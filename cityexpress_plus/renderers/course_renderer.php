...
/**
 * Theme cityexpress_plus course renderer class inherit from core course renderer class.
 * @copyright  2015 onwards LMSACE Dev Team (http://www.lmsace.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_cityexpress_plus_core_course_renderer extends core_course_renderer {
     ...
     * @return string
     */
    public function cityexpress_plus_coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        $classes = array('category');
        if (empty($coursecat->visible)) {
            $classes[] = 'dimmed_category';
        }
    ...
    public function top_course_menu() {
        ...
        '.get_string('viewall', 'theme_cityexpress_plus').'</a></li></ul>';
    ...
    //         $output .= html_writer::tag('h2', get_string('search_courses', 'theme_cityexpress_plus'));
    //     }
    ...
    //             'size' => $inputsize,
    //             'name' => 'search',
    //             'placeholder' => get_string('typesearch', 'theme_cityexpress_plus'),
    //             'value' => s($value)));
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        // $course_percentage = theme_cityexpress_plus_get_user_progress($course);
...
// print enrolmenticons
        ...
        $completion_information = theme_cityexpress_plus_completion_get_activities_in_course($course->id);
...
} // Here the theme_cityexpress_plus_course renderer fucntion closed.
