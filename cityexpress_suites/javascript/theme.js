...
$(function(){
    ...
    $val = $("#id_s_theme_cityexpress_suites_popularCourse_type").val();
    if ($val == 1) {
    ...
    $("#id_s_theme_cityexpress_suites_popularCourse_type").on('change', function() {
    ...
    var toggelSection = ['#theme_cityexpress_suites_general', '#theme_cityexpress_suites_slideshow', '#theme_cityexpress_suites_marketingspot', '#theme_cityexpress_suites_footer'];
    $.each(toggelSection, function(key, value) {
        ...
        h3.each( function(key) {
            ...
            var toggleHead = '<div class="cityexpress_suites-toggle-head" id="' + childid + '">';
    ...
    $(".cityexpress_suites-toggle-head").click(function(){
        $this = $(this);
    ...
    function toggleicon2(parentid) {
        ...
        parent.find('.cityexpress_suites-toggle-head').each(function() {
            $this = $(this);
